...
//	}
	...
	public ArrayList findusers() throws SQLException {
		String sql = "select username Username, email Email, password Password from users";
		return findObjs(sql, Users.class);
	}

	@Override
	public Users finduser(String string) throws SQLException {
		String sql = "select username Username, password Password, email Email from users where username = ?";
		Object[] params = {string};
